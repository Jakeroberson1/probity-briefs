---
title: "GRAIL Galleri multi-cancer early detection (MCED) blood test: FDA panel vote"
date: 2026-09-21
event: "FDA panel vote, Sep 23, 2026"
verdict: "YES, 65%"
probability: 65
method_version: v1.0
---
...
> **TL;DR**
>
> **The call.** **YES, 65%** on Voting Question 3.
>
> **Versus the crowd.** The crowd reads 70-75% (72.5% midpoint). Probity is 7.5 points below it, same side of the call.
>
> **The crux.** Galleri catches about one in six cancers at stage I. The fight is whether that is enough to keep the words "early detection" on the label, or whether the claim drops to plain detection.
>
> **Scenarios.** What each outcome would settle. These are not positions to take:
> - *Yes on all three questions, early detection wording intact:* The first multi-cancer screening test clears panel review with its claim whole, and the open question moves to CMS, which has never paid for a multi-cancer screen.
> - *Yes on benefit-risk, but the panel presses to drop "early":* Approval stays on track while the claim narrows, which is roughly what the sell side already expects, and it settles nothing about whether the test moves cancers to earlier stages.
> - *No on effectiveness:* The objection to a surrogate endpoint wins, and every company behind GRAIL in multi-cancer screening inherits a harder evidentiary bar for the same kind of data.

---

**Verdict: YES, 65% probability of YES.**
...
- [S3] page 18 (PATHFINDER 2 Table 6): "Overall, the Galleri 12-month episode sensitivity was 35.0% (95% CI: 29.8%, 40.5%), specificity was 99.85%"
- [S3] page 11 (PATHFINDER 2 Target Clinical Outcome Definitions): "there is uncertainty in the extent to which 12-month episode sensitivity is representative of true test sensitivity"
- [S3] page 19-20 (Table 9 note, PATHFINDER 2): "In general, for each cancer type with guideline-recommended screening, the Galleri 12-month episode sensitivity was higher in individuals not eligible for screening than those eligible for screening."
...
- [S3] page 18 (PATHFINDER 2 Table 7): "The Galleri test false positive rate was 0.15% (95% CI: 0.09%, 0.25%)"
- [S3] page 16 (PATHFINDER 2 AE summary): "None of the AEs were related to the device, and all occurred during the targeted diagnostic evaluation."
- [S1] page 1: "A test result of No Cancer Signal Detected does not rule out the presence of cancer, and individuals should continue with guideline-recommended single-cancer screening tests."
...
- [S5] page 2 (TVM roster): "Jason A. Dominitz, MD, MHS Executive Director, National Gastroenterology and Hepatology Program Director, National Colorectal Cancer Screening Program"
- [S7] page 3 (Discussion): "Breath Diagnostics is engaged in research to develop a diagnostic test specifically for lung cancer."
...
- Whether Galleri's episode sensitivity by stage (especially the low stage I sensitivity) actually supports labeling the test as 'early detection' rather than just 'detection'.
...
- [S1] page 1-2: "Please discuss whether Galleri performance by stage (overall and per cancer type) supports the proposed indications for use of 'early' detection of multiple types of cancer."
- [S3] page 15 (PATHFINDER 2 Primary Safety Analysis): "FDA does not have outstanding questions for the Panel on the primary safety analysis."
- [S1] page 1: "Please discuss whether there are any cancer types where Galleri's cancer type detection performance presents new risks (e.g., due to uncertainty in performance estimates) and for which risk mitigations may be needed."
...
- [S4] page 25 (Background on Cancer and Screening): "More than 70% of US cancer-related deaths arise from cancers without population-based screening recommendations."
...
- [S3] page 8 (Regulatory History): "An earlier version of the test was launched in June 2021, available by prescription in the U.S."
...
- **S1.** [MCGP Sept. 23, 2026 FDA Panel Questions](https://www.fda.gov/media/194907/download). Fetched 2026-09-21 23:07 UTC. 2 pages.
- **S2.** [MCGP Sept. 23, 2026 Voting Questions](https://www.fda.gov/media/194908/download). Fetched 2026-09-21 23:07 UTC. 2 pages.
- **S3.** [MCGP Sept. 23, 2026 FDA Executive Summary](https://www.fda.gov/media/194909/download). Fetched 2026-09-21 23:07 UTC. 55 pages.
- **S4.** [MCGP Sept. 23, 2026 GRAIL Executive Summary](https://www.fda.gov/media/194910/download). Fetched 2026-09-21 23:07 UTC. 111 pages.
- **S5.** [MCGP Sept. 23, 2026 Roster](https://www.fda.gov/media/194906/download). Fetched 2026-09-21 23:08 UTC. 4 pages.
- **S6.** [MCGP Sept. 23, 2026 Waiver Acknowledgment - Dr. Victor van Berkel](https://www.fda.gov/media/194756/download). Fetched 2026-09-21 23:08 UTC. 2 pages.
- **S7.** [MCGP Sept. 23, 2026 Waiver - Dr. Victor van Berkel](https://www.fda.gov/media/194757/download). Fetched 2026-09-21 23:08 UTC. 7 pages.
- **S8.** [Federal Register notice](https://www.federalregister.gov/documents/2026/08/10/2026-16245/molecular-and-clinical-genetics-panel-of-the-medical-devices-advisory-committee-notice-of-meeting). Fetched 2026-09-21 23:08 UTC.
- **S9.** [FDA meeting page](https://www.fda.gov/advisory-committees/advisory-committee-calendar/september-23-2026-molecular-and-clinical-genetics-panel-medical-devices-advisory-committee-meeting). Fetched 2026-09-21 23:08 UTC.
- **S10.** [CMS Open Payments cross-check](https://openpaymentsdata.cms.gov). Fetched 2026-09-21 23:17 UTC.

Precedents considered, same committee first:

- **P1.** TriClip TEER (Abbott), 2024-02-13, same FDA center (CDRH).
- **P2.** Symplicity Spyral renal denervation (Medtronic), 2023-08-23, same FDA center (CDRH).
- **P3.** Paradise renal denervation (ReCor / Otsuka), 2023-08-22, same FDA center (CDRH).
- **P4.** Kisunla / donanemab (Eli Lilly), 2024-06-10, other committee.
- **P5.** MDMA-assisted therapy (Lykos), 2024-06-04, other committee.
- **P6.** Rytelo / imetelstat (Geron), 2024-03-14, other committee.
- **P7.** Casgevy (Vertex / CRISPR), 2023-10-31, other committee.
- **P8.** Leqembi / lecanemab (Eisai / Biogen), 2023-06-09, other committee.
- **P9.** Ocaliva / obeticholic acid NASH (Intercept), 2023-05-19, other committee.
- **P10.** Elevidys (Sarepta), 2023-05-12, other committee.

Not available when this brief was written:

- Public docket comments: none entered (add them under docket_comments in the event file)

## Consensus at brief time

Captured 2026-09-21 23:24 UTC.

- Crowd read: 70-75%
- Favorable means: a majority YES on the primary benefit-risk question
- Market reaction: GRAL soared 34% on Sep 21 to $107.97, its biggest one-day gain since 2025. The market is pricing a favorable vote.
- Sell side sentiment: Piper Sandler's David Westenberg notes the documents suggest approval is likely with a potential label modification. He expects a favorable vote, but with a price target of $74 rather than today's $108.
- Bear case: NHS-Galleri missed its primary endpoint, and roughly half of the people told a cancer signal was detected actually had cancer.
  - **What the FDA package says:** Both halves of that are wrong on the documents. PPV was 77.0% in PATHFINDER 2 and 66.2% in NHS-Galleri, not roughly half, against a false positive rate of 0.15%. And the missed endpoint was the reduction in stage IV cancers, which FDA describes as a secondary objective of NHS-Galleri with no formal statistical testing; GRAIL claims nothing about it in the proposed indication, and FDA is explicitly not asking the panel about it. (FDA Executive Summary, pages 18, 32 and 37.)
- Summary: Optimistic into the vote (market +34%, analysts expect favorable). The debate is narrowed to whether the panel agrees with the early detection label.
